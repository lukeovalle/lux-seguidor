...
#define ojo_der_ext_Pin GPIO_PIN_1
#define ojo_der_ext_GPIO_Port GPIOC
#define ojo_izq_ext_Pin GPIO_PIN_1
#define ojo_izq_ext_GPIO_Port GPIOA
#define USART_TX_Pin GPIO_PIN_2
#define USART_TX_GPIO_Port GPIOA
#define USART_RX_Pin GPIO_PIN_3
#define USART_RX_GPIO_Port GPIOA
#define ojo_izq_int_Pin GPIO_PIN_4
#define ojo_izq_int_GPIO_Port GPIOA
